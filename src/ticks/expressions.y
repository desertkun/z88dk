...
calculation:
	...
	| error_expression 							{ set_expression_result_error($1); }
;

pointer_expression: T_POINTER
	| T_AMPERSAND value_expression						{
		$$.type = EXPRESSION_RESULT_POINTER;
		$$.as_pointer.ptr = $2.memory_location;
		$$.as_pointer.element_size = $2.memory_size;
		$$.as_pointer.underlying_type = $2.type;
	 }
	| T_LEFT type_expression T_STAR T_RIGHT pointer_expression		{ expression_value_to_pointer(&$5, &$$, $2.type); }
	| T_LEFT type_expression T_STAR T_RIGHT value_expression		{ expression_value_to_pointer(&$5, &$$, $2.type); }
...
value_expression: T_PRIMITIVE_VALUE
	...
	| T_LEFT type_expression T_RIGHT value_expression			{ convert_expression(&$4, &$$, $2.type); }
	| T_LEFT type_expression T_RIGHT value_expression			{ convert_expression(&$4, &$$, $2.type); }
